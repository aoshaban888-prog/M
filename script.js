...
function getTypeIcon(type) {
  ...
  return icons[type] || `<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;flex-shrink:0"><path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/></svg>`;
}
    ...
    <article class="alert-item ${urgentClass}">
      <div class="alert-top">
        ...
        <div style="display:flex; gap:6px; flex-wrap:wrap;">
          ...
          <span class="days-pill ${pillClass}">${getDaysLabel(days)}</span>
        </div>
      </div>
      <strong style="font-size:0.97rem;">${item.title}</strong>
      ${item.refNumber ? `<div class="alert-meta" style="color:var(--muted);font-size:0.82rem;">📝 ${item.refNumber}</div>` : ''}
      ...
      ? list.map(({ item, i }) => {
          ...
          return `<article class="manage-item">
            <div class="manage-item-top">
              <strong style="display:inline-flex;align-items:center;gap:6px;">${getTypeIcon(item.type)}${item.title}${item.refNumber ? `<span style="font-size:0.78rem;font-weight:500;color:var(--primary-2);background:rgba(94,168,255,0.1);border:1px solid rgba(94,168,255,0.25);border-radius:8px;padding:2px 8px;">#${item.refNumber}</span>` : ''}</strong>
              <div style="display:flex;gap:6px;flex-wrap:wrap;">
...
function addThemeToggle() {
  ...
  btn.innerHTML = isLight
    ? `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:5px"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg>ليلي`
    : `<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="vertical-align:middle;margin-left:5px"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>نهاري`;
